    ...
    $("form#form").on("submit", function () {
        ...
        if ($(".requiredField").each(function () {
            ...
            $.post($(this).attr("action"), r, function () {
                ...
                $("form#form").before('<div class="success contact-us-success">Merci pour votre message. Nous vous contactero' +
                ...
                // $(this).before('<div class="success text-success">Merci pour votre message.
                // Nous vous contactero' +                 'ns sous les 48h (jours
                // ouvrables).</div>');         $('.contact-submit-button').prop('disabled',
                // false);     });
